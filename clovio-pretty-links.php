<?php
/**
 * Plugin Name:     Clovio Pretty Links
 * Plugin URI:      github.com/chigozieorunta/clovio-pretty-links
 * Description:     Displays list of Pretty links and prevents user with Author roles from gaining access to main Pretty links.
 * Author:          Chigozie Orunta
 * Author URI:      github.com/chigozieorunta
 * Text Domain:     clovio-pretty-links
 * Domain Path:     /languages
 * Version:         0.1.0
 *
 * @package         Clovio_Pretty_Links
 */
...
function crb_attach_theme_options() {
    ...
    */
    ...
    $basic_options_container = Container::make( 'theme_options', __( 'Clovio Pretty Links' ) )
